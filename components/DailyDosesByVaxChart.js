    ...
    for (const bar of payload) {
      return (
        <div className="flex flex-col text-white p-2 bg-gray-900 text-sm">
          {bar.payload.projection ? (
            <p className="text-yellow-300">Projected for</p>
          ) : (
            ""
          )}
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <ReferenceArea
          x1={dosesData[dosesData.length - 7]["date"]}
          x2={dosesData[dosesData.length - 1]["date"]}
          fill="#4B5563"
        />
        <Text />
        <Bar
        ...
        >
          {dosesData.map((entry, index) => (
            <Cell
              key={entry["date"]}
              fill={entry["projection"] ? "#34D39999" : "#34D399ff"}
            />
          ))}
        </Bar>
        <Bar
        ...
        >
          {dosesData.map((entry, index) => (
            <Cell
              key={entry["date"]}
              fill={entry["projection"] ? "#34D39966" : "#34D399cc"}
            />
          ))}
        </Bar>
        <Bar
        ...
        >
          {dosesData.map((entry, index) => (
            <Cell
              key={entry["date"]}
              fill={entry["projection"] ? "#34D39933" : "#34D39999"}
            />
          ))}
        </Bar>
        <Bar
        ...
        >
          {dosesData.map((entry, index) => (
            <Cell
              key={entry["date"]}
              fill={entry["projection"] ? "#60A5FA99" : "#60A5FAff"}
            />
          ))}
        </Bar>
        <Bar
        ...
        >
          {dosesData.map((entry, index) => (
            <Cell
              key={entry["date"]}
              fill={entry["projection"] ? "#60A5FA66" : "#60A5FAcc"}
            />
          ))}
        </Bar>
        <Bar
        ...
        >
          {dosesData.map((entry, index) => (
            <Cell
              key={entry["date"]}
              fill={entry["projection"] ? "#60A5FA33" : "#60A5FA99"}
            />
          ))}
        </Bar>
      </BarChart>
